...
export default function CustomCursor() {
  ...
  return (
    <motion.div
      ref={cursorRef}
      className="airportlive-custom-cursor fixed top-0 left-0 z-[9999] pointer-events-none mix-blend-difference hidden md:flex items-center justify-center text-white text-[10px] font-bold uppercase tracking-widest text-center"
      style={{
        x: cursorX,
        y: cursorY,
      }}
