        ...
        <div className="mb-16 hidden sm:block">
          ...
          >
            ...
            {[
              ...
              <g key={city.label}>
                <circle cx={city.cx} cy="30" r="6" fill="#D1D1D1" />
          ...
          {routes.map((route) => {
            ...
            return (
              <div
                ...
                data-route-card
                className="group relative rounded-2xl border border-[rgba(26,18,8,0.08)] bg-[#FDFAF3] p-7 transition-all duration-300 hover:border-[rgba(200,200,220,0.32)] hover:shadow-[0_16px_50px_rgba(23,17,10,0.08)] hover:-translate-y-0.5"
              >
                {route.popular && (
                  <span className="absolute right-5 top-5 rounded-full bg-[#D1D1D1]/10 px-3 py-1 font-[family-name:var(--font-jetbrains-mono)] text-[9px] font-bold uppercase tracking-[0.15em] text-[#D1D1D1]">
                    Popular
                  </span>
                )}
                ...
                <div className="mb-5 flex items-center gap-3">
                  <MapPin className="h-4 w-4 shrink-0 text-[#D1D1D1]" />
                ...
                <a
                  ...
                  className="mt-5 inline-flex items-center gap-2 rounded-full border border-[rgba(200,200,220,0.32)] bg-[#D1D1D1]/5 px-4 py-2 text-xs font-semibold text-[#D1D1D1] transition-all duration-300 hover:bg-[#D1D1D1] hover:text-white"
                >
