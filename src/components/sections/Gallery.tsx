...
export default function Gallery() {
  return (
    <section className="relative overflow-hidden bg-[#0A0A0A] pt-10 pb-16 text-white md:py-24" aria-label="Photo gallery">
      {/* Ambient gold glow */}
        ...
        <div className="grid grid-cols-3 gap-3 md:gap-4">
          {GALLERY_IMAGES.map((item, i) => (
            <motion.div 
              ...
              className="aspect-[4/5] bg-[#2a2a2a] rounded-[14px] overflow-hidden relative group cursor-pointer sm:aspect-square md:rounded-[16px]"
              data-cursor="EXPLORE"
            >
              <ResponsiveImage
                {...item.image}
