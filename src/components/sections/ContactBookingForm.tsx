      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <form onSubmit={handleSubmit} className="bg-[#1A1A1A] p-8 md:p-10 rounded-[24px] border border-white/10 shadow-sm space-y-6">
          ...
          <fieldset className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input id="contact-name" type="text" required value={form.name} onChange={e => update('name', e.target.value)} placeholder="Your name" autoComplete="name" className="w-full border border-white/10 bg-[#0A0A0A] text-white rounded-xl px-4 py-3 focus:border-[#E5E4E2] outline-none text-base placeholder:text-[#A3A3A3]" />
              </div>
              <div>
                <label htmlFor="contact-phone" className="block text-xs text-[#A3A3A3] uppercase mb-1 font-semibold">Phone *</label>
                <input id="contact-phone" type="tel" required value={form.phone} onChange={e => update('phone', e.target.value)} placeholder="+91..." autoComplete="tel" className="w-full border border-white/10 bg-[#0A0A0A] text-white rounded-xl px-4 py-3 focus:border-[#E5E4E2] outline-none text-base placeholder:text-[#A3A3A3]" />
              </div>
              <div>
                <label htmlFor="contact-email" className="block text-xs text-[#A3A3A3] uppercase mb-1 font-semibold">Email</label>
                <input id="contact-email" type="email" value={form.email} onChange={e => update('email', e.target.value)} placeholder="Optional" autoComplete="email" className="w-full border border-white/10 bg-[#0A0A0A] text-white rounded-xl px-4 py-3 focus:border-[#E5E4E2] outline-none text-base placeholder:text-[#A3A3A3]" />
              </div>
            </div>
          </fieldset>
          ...
          <fieldset className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input id="contact-pickup" type="text" required value={form.pickup} onChange={e => update('pickup', e.target.value)} placeholder="City or Airport" className="w-full border border-white/10 bg-[#0A0A0A] text-white rounded-xl px-4 py-3 focus:border-[#E5E4E2] outline-none text-base placeholder:text-[#A3A3A3]" />
              </div>
              <div>
                <label htmlFor="contact-drop" className="block text-xs text-[#A3A3A3] uppercase mb-1 font-semibold">Drop *</label>
                <input id="contact-drop" type="text" required value={form.drop} onChange={e => update('drop', e.target.value)} placeholder="City or Airport" className="w-full border border-white/10 bg-[#0A0A0A] text-white rounded-xl px-4 py-3 focus:border-[#E5E4E2] outline-none text-base placeholder:text-[#A3A3A3]" />
              </div>
            </div>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div>
                <label htmlFor="contact-date" className="block text-xs text-[#A3A3A3] uppercase mb-1 font-semibold">Date *</label>
                <input id="contact-date" type="date" required value={form.date} onChange={e => update('date', e.target.value)} className="w-full border border-white/10 bg-[#0A0A0A] text-white rounded-xl px-4 py-3 focus:border-[#E5E4E2] outline-none text-base placeholder:text-[#A3A3A3]" />
              </div>
              <div>
                <label htmlFor="contact-time" className="block text-xs text-[#A3A3A3] uppercase mb-1 font-semibold">Time</label>
                <input id="contact-time" type="time" value={form.time} onChange={e => update('time', e.target.value)} className="w-full border border-white/10 bg-[#0A0A0A] text-white rounded-xl px-4 py-3 focus:border-[#E5E4E2] outline-none text-base placeholder:text-[#A3A3A3]" />
              </div>
              <div>
                <label htmlFor="contact-passengers" className="block text-xs text-[#A3A3A3] uppercase mb-1 font-semibold">Passengers</label>
                <select id="contact-passengers" value={form.passengers} onChange={e => update('passengers', e.target.value)} className="w-full border border-white/10 bg-[#0A0A0A] text-white rounded-xl px-4 py-3 focus:border-[#E5E4E2] outline-none text-base placeholder:text-[#A3A3A3]">
              ...
              <div>
                ...
                <select id="contact-vehicle" value={form.vehicle} onChange={e => update('vehicle', e.target.value)} className="w-full border border-white/10 bg-[#0A0A0A] text-white rounded-xl px-4 py-3 focus:border-[#E5E4E2] outline-none text-base placeholder:text-[#A3A3A3]">
          ...
          <div>
            ...
            <textarea id="contact-notes" rows={3} value={form.notes} onChange={e => update('notes', e.target.value)} placeholder="Flight number, special requests, etc." className="w-full border border-white/10 rounded-xl px-4 py-3 focus:border-[#E5E4E2] outline-none text-base resize-none" />
          </div>
